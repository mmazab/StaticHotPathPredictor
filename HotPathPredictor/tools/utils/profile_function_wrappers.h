...
const char * memprof_strchr(const char *s, int c);
const char * memprof_strrchr(const char *s, int c);
...
const char * memprof_strstr(const char *s1, const char *s2);
...
const char * memprof_strpbrk(const char *s1, const char *s2);
...
/*    memprof_write_region(&sys_nerr, sizeof(sys_nerr));*/   // warning 
...
// ajamshid 9/4/13 - changed to return const char * (was char *)
const char * memprof_strchr(const char *s, int c) {
